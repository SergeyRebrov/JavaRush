...
public class Solution {
    public static void main(String[] args) throws Exception {
        ...
        solution.sendPost("http://requestb.in/1gstrp11", "name=zapp&mood=good&locale=&id=777");
    }
    ...
    public void sendPost(String url, String urlParameters) throws Exception {
        ...
        for (int i = 0; i < parameters.length; i++)
        {
            ...
            nameValuePairs.add(new BasicNameValuePair(parameter.substring(0, parameter.indexOf("=")), parameter.substring(parameter.indexOf("=") + 1)));
        }
