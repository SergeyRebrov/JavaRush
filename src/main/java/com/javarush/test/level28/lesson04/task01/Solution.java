...
public class Solution {
    ...
    private static AtomicInteger countGroup = new AtomicInteger(0);
    ...
    public static class AmigoThreadFactory implements ThreadFactory
    {
        ...
        public AmigoThreadFactory() {
            number = countGroup.incrementAndGet();
        }
        @Override
        public Thread newThread(Runnable r)
        {
            ...
            thread.setName(Thread.currentThread().getThreadGroup().getName() + "-pool-" + number + "-thread-" + countThread.incrementAndGet());
            return thread;
        }
    }
}
